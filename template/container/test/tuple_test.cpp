...
//
    TesterWithBuilder<1>::test("get", [](auto &&builder) {
        auto c1 = make_copy_counter<boq_tuple>();
        auto c2 = make_copy_counter<std_tuple>();
        static_assert(std::is_same_v<container::front_t<container::Tuple<int, bits_of_q::IndexedCopyCounter<1>, bool>>, int>);
        auto &&tuple1 = builder.build(container::Tuple{42, c1, true});
